...
*  \file       hello_world.c
*
*  \details    Passing command to kernel Device Driver
*
*  \author     Harish Panicker
*
* *******************************************************************************/
...
static int __init module_parameter_init(void)
{
        int i;
...
static void __exit module_parameter_exit(void)
{
...
MODULE_DESCRIPTION("passing argument to Kernel Device Driver");
